				...
				<div class="x_panel">
					...
					<div class="x_content">
						...
						<form:form modelAttribute="modelForm" cssClass="form-horizontal form-label-left" servletRelativeAction="/category/save" method="POST">
							...
							<!-- sua cho nay ========-->
							<div class="form-group">
								<label for="createdate" class="control-label col-md-3 col-sm-3 col-xs-12">CreateDate</label>
								<div class="col-md-6 col-sm-6 col-xs-12">
									<form:input path="creatdate" cssClass="form-control col-md-7 col-xs-12" disabled="${viewOnly}" />
									<div class="has-error">
										<form:errors path="createdate" cssClass="help-block"></form:errors>
									</div>
								</div>
							</div>
