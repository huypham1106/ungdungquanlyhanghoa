...
public class HistoryController {
	...
	public String list(Model model, @ModelAttribute("searchForm") History history,@PathVariable("page") int page) {
		...
		mapType.put(String.valueOf(Constant.TYPE_ALL), "All");//0
		mapType.put(String.valueOf(Constant.TYPE_GOODS_RECEIPT), "Goods Receipt");//1
		mapType.put(String.valueOf(Constant.TYPE_GOODS_ISSUES), "Goods Issues");//2
