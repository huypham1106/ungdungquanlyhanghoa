...
public class ProductInfoValidator implements Validator{
	...
	public void validate(Object target, Errors errors) {
		// TODO Auto-generated method stub
		ProductInfo productInfo=(ProductInfo) target;//ép kiểu
		...
		if(!productInfo.getMultipartFile().getOriginalFilename().isEmpty()) // để kiểm tra đuôi file hìn ảnh là .jpg hay .png mới cho add vào
		{
		String extension =	FilenameUtils.getExtension(productInfo.getMultipartFile().getOriginalFilename());
		if(!extension.equals("jpg") && !extension.equals("png"))
		{
			errors.rejectValue("multipartFile", "msg.file.extension.error");// trong message.properties hiện thông báo lỗi
		}
		}
	}
}
